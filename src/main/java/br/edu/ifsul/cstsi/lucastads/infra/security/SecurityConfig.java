package br.edu.ifsul.cstsi.lucastads.infra.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authorize -> {  //configurar a autorização
                ...
                authorize.requestMatchers(HttpMethod.POST, "/auth/login", "/auth/register").permitAll(); //exceto, a rota de login e de cadastro de usuário
